...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str,  default='CrossGNN', help='model name')
    # data loader
    parser.add_argument('--data', type=str, default='custom', help='dataset type')
    parser.add_argument('--root_path', type=str, default='./dataset/', help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='Location1_hd.csv', help='data file')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_fc{}_eb{}_dt{}_{}_{}_lr{}_ngcn{}_tgcn{}_ood{}_td{}_nd{}_loss{}_layer{}_scale{}_hidden{}_tk{}'.format(
                args.model_id,
                args.model,
                args.data,
                args.features,
